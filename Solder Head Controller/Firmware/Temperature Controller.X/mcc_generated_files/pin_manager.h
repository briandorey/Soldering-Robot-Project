...
*/
#define LCD_Reset_SetHigh()          _LATD1 = 1
/**
  @Summary
...
*/
#define LCD_Reset_SetLow()           _LATD1 = 0
/**
  @Summary
...
*/
#define LCD_Reset_Toggle()           _LATD1 ^= 1
/**
  @Summary
...
*/
#define LCD_Reset_GetValue()         _RD1
/**
  @Summary
...
*/
#define LCD_Reset_SetDigitalInput()  _TRISD1 = 1
/**
  @Summary
...
*/
#define LCD_Reset_SetDigitalOutput() _TRISD1 = 0
/**
  @Summary
...
*/
#define LCD_Mode_SetHigh()          _LATD3 = 1
/**
  @Summary
...
*/
#define LCD_Mode_SetLow()           _LATD3 = 0
/**
  @Summary
...
*/
#define LCD_Mode_Toggle()           _LATD3 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RD3
    postValue = LCD_Mode_GetValue();
    </code>

*/
#define LCD_Mode_GetValue()         _RD3
/**
  @Summary
  ...
  @Example
    ...
    LCD_Mode_SetDigitalInput();
    </code>

*/
#define LCD_Mode_SetDigitalInput()  _TRISD3 = 1
/**
  @Summary
  ...
  @Example
    ...
    LCD_Mode_SetDigitalOutput();
    </code>

*/
#define LCD_Mode_SetDigitalOutput() _TRISD3 = 0
/**
  @Summary
...
*/
#define Button_Menu_SetHigh()          _LATD8 = 1
/**
  @Summary
...
*/
#define Button_Menu_SetLow()           _LATD8 = 0
/**
  @Summary
  ...
  @Example
    <code>
    // Toggle RD8
    Button_Menu_SetToggle();
    </code>

*/
#define Button_Menu_Toggle()           _LATD8 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RD8
    postValue = Button_Menu_GetValue();
    </code>

*/
#define Button_Menu_GetValue()         _RD8
/**
  @Summary
  ...
  @Example
    ...
    Button_Menu_SetDigitalInput();
    </code>

*/
#define Button_Menu_SetDigitalInput()  _TRISD8 = 1
/**
  @Summary
  ...
  @Example
    ...
    Button_Menu_SetDigitalOutput();
    </code>

*/
#define Button_Menu_SetDigitalOutput() _TRISD8 = 0
/**
  @Summary
...
*/
#define Button_Up_SetHigh()          _LATD9 = 1
/**
  @Summary
...
*/
#define Button_Up_SetLow()           _LATD9 = 0
/**
  @Summary
...
*/
#define Button_Up_Toggle()           _LATD9 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RD9
    postValue = Button_Up_GetValue();
    </code>

*/
#define Button_Up_GetValue()         _RD9
/**
  @Summary
...
*/
#define Button_Up_SetDigitalInput()  _TRISD9 = 1
/**
  @Summary
  ...
  @Example
    ...
    Button_Up_SetDigitalOutput();
    </code>

*/
#define Button_Up_SetDigitalOutput() _TRISD9 = 0
/**
  @Summary
...
*/
#define Button_Down_SetHigh()          _LATD10 = 1
/**
  @Summary
...
*/
#define Button_Down_SetLow()           _LATD10 = 0
/**
  @Summary
  ...
  @Example
    <code>
    // Toggle RD10
    Button_Down_SetToggle();
    </code>

*/
#define Button_Down_Toggle()           _LATD10 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RD10
    postValue = Button_Down_GetValue();
    </code>

*/
#define Button_Down_GetValue()         _RD10
/**
  @Summary
...
*/
#define Button_Down_SetDigitalInput()  _TRISD10 = 1
/**
  @Summary
  ...
  @Example
    ...
    Button_Down_SetDigitalOutput();
    </code>

*/
#define Button_Down_SetDigitalOutput() _TRISD10 = 0
/**
  @Summary
  ...
  @Example
    <code>
    // Set RD11 high (1)
    Button_Enter_SetHigh();
    </code>

*/
#define Button_Enter_SetHigh()          _LATD11 = 1
/**
  @Summary
...
*/
#define Button_Enter_SetLow()           _LATD11 = 0
/**
  @Summary
  ...
  @Example
    <code>
    // Toggle RD11
    Button_Enter_SetToggle();
    </code>

*/
#define Button_Enter_Toggle()           _LATD11 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RD11
    postValue = Button_Enter_GetValue();
    </code>

*/
#define Button_Enter_GetValue()         _RD11
/**
  @Summary
  ...
  @Example
    ...
    Button_Enter_SetDigitalInput();
    </code>

*/
#define Button_Enter_SetDigitalInput()  _TRISD11 = 1
/**
  @Summary
  ...
  @Example
    ...
    Button_Enter_SetDigitalOutput();
    </code>

*/
#define Button_Enter_SetDigitalOutput() _TRISD11 = 0
/**
  @Summary
...
*/
#define SolderHead_2_SetHigh()          _LATE0 = 1
/**
  @Summary
...
*/
#define SolderHead_2_SetLow()           _LATE0 = 0
/**
  @Summary
  ...
  @Example
    <code>
    // Toggle RE0
    SolderHead_2_SetToggle();
    </code>

*/
#define SolderHead_2_Toggle()           _LATE0 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RE0
    postValue = SolderHead_2_GetValue();
    </code>

*/
#define SolderHead_2_GetValue()         _RE0
/**
  @Summary
  ...
  @Example
    ...
    SolderHead_2_SetDigitalInput();
    </code>

*/
#define SolderHead_2_SetDigitalInput()  _TRISE0 = 1
/**
  @Summary
  ...
  @Example
    ...
    SolderHead_2_SetDigitalOutput();
    </code>

*/
#define SolderHead_2_SetDigitalOutput() _TRISE0 = 0
/**
  @Summary
...
*/
#define SolderHead_1_SetHigh()          _LATE1 = 1
/**
  @Summary
...
*/
#define SolderHead_1_SetLow()           _LATE1 = 0
/**
  @Summary
  ...
  @Example
    <code>
    // Toggle RE1
    SolderHead_1_SetToggle();
    </code>

*/
#define SolderHead_1_Toggle()           _LATE1 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RE1
    postValue = SolderHead_1_GetValue();
    </code>

*/
#define SolderHead_1_GetValue()         _RE1
/**
  @Summary
  ...
  @Example
    ...
    SolderHead_1_SetDigitalInput();
    </code>

*/
#define SolderHead_1_SetDigitalInput()  _TRISE1 = 1
/**
  @Summary
  ...
  @Example
    ...
    SolderHead_1_SetDigitalOutput();
    </code>

*/
#define SolderHead_1_SetDigitalOutput() _TRISE1 = 0
/**
  @Summary
...
*/
#define SolderHead_LED1_SetHigh()          _LATE2 = 1
/**
  @Summary
...
*/
#define SolderHead_LED1_SetLow()           _LATE2 = 0
/**
  @Summary
  ...
  @Example
    <code>
    // Toggle RE2
    SolderHead_LED1_SetToggle();
    </code>

*/
#define SolderHead_LED1_Toggle()           _LATE2 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RE2
    postValue = SolderHead_LED1_GetValue();
    </code>

*/
#define SolderHead_LED1_GetValue()         _RE2
/**
  @Summary
  ...
  @Example
    ...
    SolderHead_LED1_SetDigitalInput();
    </code>

*/
#define SolderHead_LED1_SetDigitalInput()  _TRISE2 = 1
/**
  @Summary
  ...
  @Example
    ...
    SolderHead_LED1_SetDigitalOutput();
    </code>

*/
#define SolderHead_LED1_SetDigitalOutput() _TRISE2 = 0
/**
  @Summary
...
*/
#define SolderHead_LED2_SetHigh()          _LATE3 = 1
/**
  @Summary
...
*/
#define SolderHead_LED2_SetLow()           _LATE3 = 0
/**
  @Summary
  ...
  @Example
    <code>
    // Toggle RE3
    SolderHead_LED2_SetToggle();
    </code>

*/
#define SolderHead_LED2_Toggle()           _LATE3 ^= 1
/**
  @Summary
  ...
  @Example
    ...
    // Read RE3
    postValue = SolderHead_LED2_GetValue();
    </code>

*/
#define SolderHead_LED2_GetValue()         _RE3
/**
  @Summary
  ...
  @Example
    ...
    SolderHead_LED2_SetDigitalInput();
    </code>

*/
#define SolderHead_LED2_SetDigitalInput()  _TRISE3 = 1
/**
  @Summary
  ...
  @Example
    ...
    SolderHead_LED2_SetDigitalOutput();
    </code>

*/
#define SolderHead_LED2_SetDigitalOutput() _TRISE3 = 0
/**
  @Summary
...
*/
#define U2RX_SetDigitalInput()  _TRISG6 = 1
/**
  @Summary
...
*/
#define U2RX_SetDigitalOutput() _TRISG6 = 0
/**
  @Summary
...
*/
#define U2TX_SetDigitalInput()  _TRISG7 = 1
/**
  @Summary
...
*/
#define U2TX_SetDigitalOutput() _TRISG7 = 0
/**
  @Summary
...
*/
#define U1RX_SetDigitalInput()  _TRISG9 = 1
/**
  @Summary
...
*/
#define U1RX_SetDigitalOutput() _TRISG9 = 0
